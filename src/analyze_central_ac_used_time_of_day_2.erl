-module (analyze_central_ac_used_time_of_day_2).
...
get_meter_first_and_last_report_used_time_of_date(Meter_type, Meter, Date) ->
    case get_report_list(Meter, Date) of
        {ok, Report_list} ->
            ...
            First_used_time = analyze_report_util:get_three_speed_used_time(Meter_type, First_line),
...
cal_used_time_of_day(Meter, Date, Last_used_time = [Last_low_speed_used_time, Last_medium_speed_used_time, Last_high_speed_used_time], 
    ...
    Three_speed_used_time_of_day_filepath = analyze_util:get_three_speed_used_time_of_day_filepath(Date, Meter),
    case append_to_file(Three_speed_used_time_of_day_filepath, New_content) of
        ok -> ok;
        {error, Reason} ->
